...
var _StyledP5 = (0, _styledComponents['default'])('p').withConfig({
  ...
  componentId: 'sc-7o677h-7',
})(['color:blue;']);

var CssHelperProp = function CssHelperProp(p) {
  return <_StyledP5>A</_StyledP5>;
};
/*
 * Dynamic prop
 */
...
var ObjectPropMixedInputs = function ObjectPropMixedInputs(p) {
  var color = 'red';
  return (
    <_StyledP12 _css4={p.background} _css5={color} _css6={globalVar} _css7={getAfterValue()}>
      A
    </_StyledP12>
  );
};
...
var _StyledThing2 = (0, _styledComponents['default'])(Thing4).withConfig({
  ...
  componentId: 'sc-7o677h-22',
})(['color:red;']);

var _StyledSomeComponent = (0, _styledComponents['default'])(
  _SomeComponentPath['default'],
).withConfig({
  displayName: 'code___StyledSomeComponent',
  componentId: 'sc-7o677h-23',
})(['color:red;']);
