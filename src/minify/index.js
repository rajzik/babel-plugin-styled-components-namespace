...
import { makePlaceholder, placeholderRegex, splitByPlaceholders } from '../css/placeholderUtils';
...
export const minifyCookedValues = cookedValues =>
  splitByPlaceholders(minifyCooked(injectUniquePlaceholders(cookedValues)), false);
